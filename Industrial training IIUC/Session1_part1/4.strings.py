...
mystring='Hello my name is Ismail. I am a Student. My age is 24. I live in Bangladesh.'
bio_words=(mystring.split(' '))
print(bio_words)
print('Name:',bio_words[4])
print('Age:',bio_words[12])
print('Country:',bio_words[16])
...
dictonary={'Name':'Ismail', 'email':'ismailbabu007@gmail.com','age':'24','city':'Chittagong'}
mystring=f"This is {dictonary['Name']} and I live in {dictonary['city']} and my email is {dictonary['email']}"
print(mystring)
