...
matrix1 = [[10, 20, 30], [40, 50, 60], [70, 80, 90]] #create matrix

print(matrix1[2][2]) #accessing matrix
matrix1[0][0]=66 #modify
#print after modify
for row in matrix1:
    print(row)
...
# Write your code below:
tuple = (10, 20, 30, 40, 'abc',False) #Create a tuple
tuple_dict2 = {tuple: "My Tuple2"}
print(tuple_dict2.items())
...
# Write your code below:
list_of_tuple=[("Anas",90),("Akash",60),("Batash",80)]
print(list_of_tuple)
sorted_by_grade = sorted(list_of_tuple,key=lambda x: x[1])
print("After sorting:", sorted_by_grade)
