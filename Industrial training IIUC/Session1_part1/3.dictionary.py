...
student_dic={ 'name':'ismail','city':'chittagong',"roll_number":"C193026", "grades":[('math','A+'),('Python','F'),('English','B+')] }
print(student_dic.items())
student_dic['age']=25
student_dic.pop('city')
print(student_dic.items())
student_dic['grades']=[("Python","D")]
print("after updating",student_dic.items())
...
student_grades={
    'jack':(40,50,60),'bob':(60,70,80),'alice':(10,34,65),'charlie':(100,98,89)
}
print("Student and their gradess: ",student_grades.items())
